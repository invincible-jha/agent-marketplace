"""Plugin registry for agent-marketplace.
...
"agent_marketplace.plugins" group.
...
class PluginRegistry(Generic[T]):
    ...
    def load_entrypoints(self, group: str) -> None:
        ...
        ----------
        group:
            The entry-point group name, e.g. "agent_marketplace.plugins".
        ...
        Then at runtime::
            ...
            registry.load_entrypoints("agent_marketplace.plugins")
        """
